    ...
    void Fire()
    {
        ...
        switch (power)
        {
            ...
            case 3:
                ...
                break;
            case 4:
                GameObject bulletR2 = Instantiate(bulletObjB, transform.position + Vector3.right * 0.35f, transform.rotation); //Destroy와 반대, 생성
                ...
                break;
            case 5:
                GameObject bulletR3 = Instantiate(bulletObjB, transform.position + Vector3.right * 0.35f, transform.rotation); //Destroy와 반대, 생성
                ...
                break;
            case 6:
                GameObject bulletR4 = Instantiate(bulletObjB, transform.position + Vector3.right * 0.35f, transform.rotation); //Destroy와 반대, 생성
                GameObject bulletRR4 = Instantiate(bulletObjA, transform.position + Vector3.right * 0.7f, transform.rotation); //Destroy와 반대, 생성
                ...
                break;
            case 7:
                GameObject bulletR5 = Instantiate(bulletObjB, transform.position + Vector3.right * 0.35f, transform.rotation); //Destroy와 반대, 생성
                GameObject bulletRR5 = Instantiate(bulletObjB, transform.position + Vector3.right * 0.7f, transform.rotation); //Destroy와 반대, 생성
